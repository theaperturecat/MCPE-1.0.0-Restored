...
# Minecraft Pocket Edition 1.0.0 Code Restoration

This project aims to restore leaked MCPE 1.0.0 code from Minecraft Dungeons to working condition and to hopefully be playable.

## About the code
On March 1, 2026, a major Minecraft source code leak which included Minecraft Legacy Console edition code, Minecraft Pocket Edition 0.6.1 code and the full Minecraft Dungeons development repo occurred. The Minecraft Dungeons codebase also included part of a newer version of Pocket Edition's codebase 1.0.0, dating to around 2016-2017. This code is only partially complete as several necessary parts to run it have been stripped out and replaced with Unreal Engine 4 code.
...
- **lib-deps/Renderer**
 Was removed because it conflicted with Unreal's renderer? Model and texture code has been decompiled/recreated to work display, but it is very incomplete still.
- **src/platform** 
...
## Contributing
Contributions are welcome. Create a pull request fixing an issue or restoring a feature to the repo. If you are decompiling code try and find an android build near 1.0.0 with debug information.
...
## How to compile.
1. Place the contents of the assets folder from a Minecraft Pocket Edition 1.0.0 build (from an APK/IPA/APPX etc) inside the data folder. Please don't use pirated assets, pay for the game. Inside the data folder there should now be a few more folders and files including one called 'resource_packs'.
