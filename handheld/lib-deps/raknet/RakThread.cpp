...
#if defined(_WIN32_WCE) || defined(WINDOWS_PHONE_8) || defined(WINDOWS_STORE_RT) || defined(MCPE_PLATFORM_STORE)
...
#if   defined(WINDOWS_PHONE_8) || defined(WINDOWS_STORE_RT) || defined(MCPE_PLATFORM_STORE)
