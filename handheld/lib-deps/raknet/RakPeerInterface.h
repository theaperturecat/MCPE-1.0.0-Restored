...
public:
	...
	virtual void SendNatTraversalMessage(const SystemAddress target) = 0;
	...
	virtual unsigned GetNumberOfAdapters(void)=0;
	...
	virtual NetworkAdapter& GetLocalAdapter(unsigned int index)=0;
