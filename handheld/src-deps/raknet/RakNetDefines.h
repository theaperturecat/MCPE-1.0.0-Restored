...
// Some devices, such as newer win phones, seem to be returning a large number of ip addresses for some reason
#define MAXIMUM_NUMBER_OF_INTERNAL_IDS 20
#endif

// Maximum number of network adapters supported
#ifndef MAXIMUM_NUMBER_OF_ADAPTERS
#define MAXIMUM_NUMBER_OF_ADAPTERS 10
#endif

#ifndef MAXIMUM_HOSTNAME_LENGTH
#define MAXIMUM_HOSTNAME_LENGTH 256
#endif

#ifndef MAXIMUM_PORTNAME_LENGTH
#define MAXIMUM_PORTNAME_LENGTH 6
#endif
