...
#ifndef TAC_COMPILE
//Basically what it is in ghidra
double getTimeS()
{
...
const mce::TexturePtr mce::TexturePtr::NONE = mce::TexturePtr();
mce::RenderMaterialGroup mce::RenderMaterialGroup::switchable = mce::RenderMaterialGroup();
#endif
